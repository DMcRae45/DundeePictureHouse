        ...
        <tr>
          ...
          <td>
            <div class="form-group input-group">
              ...
              <select class="custom-select text" standardPrice="'.$priceArray[$i]->Standard_Price.'" premiumPrice="'.$priceArray[$i]->Premium_Price.'" id="'.strtolower($priceArray[$i]->Ticket_Type).'MovieType" onchange="CalculateTotalCost()">
          ...
          <td>
            <div class="form-group input-group">
              ...
              <select class="custom-select text" id="'.strtolower($priceArray[$i]->Ticket_Type).'Quantity" onchange="CalculateTotalCost()">
